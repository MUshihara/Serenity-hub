-- SERENITY / PHONK LANGUAGE PREVIEW
...
return function(theme, runtime, icons)
    ...
    function UI:Label(parent,text,size,pos,dimensions,color,bold)
        return self:New('TextLabel',parent,{Text=text,Font=bold and theme.Bold or theme.Medium,TextSize=size or 13,
            ...
            TextXAlignment=Enum.TextXAlignment.Left,TextWrapped=true,TextTruncate=Enum.TextTruncate.None})
    end
    ...
    function UI:Button(parent,text,props,callback)
        local b=self:New('TextButton',parent,{Text=text or '',Font=theme.Medium,TextSize=12,TextColor3=theme.Text,
            TextWrapped=true,BorderSizePixel=0,AutoButtonColor=false,BackgroundColor3=theme.Inset,Size=UDim2.fromOffset(100,30)})
...
return function(ui,app,parent,options,choice)
    ...
    local status=ui:Label(scroll,'Preview: reports are not sent.',12,nil,UDim2.new(1,0,0,36),ui.T.Muted)
...
return function(ui,input,state,options,mobileLayout)
    ...
    local screen=ui.R:Own(ui:New('ScreenGui',parent,{Name='SerenityPhonkLanguagePreview',ResetOnSpawn=false,IgnoreGuiInset=false,DisplayOrder=999999,ZIndexBehavior=Enum.ZIndexBehavior.Sibling}))
...
return {Version='3.1.0',APIVersion=3,Build=function(source,options)
    ...
    local key='__SERENITY_PHONK_LANGUAGE_PREVIEW'
    ...
    local app=M.App(M,{Manifest=manifest,ConfigPath='SerenityHub/ui-phonk-language-preview-v1.json'})
    app.Window=app;app.Adapter={SetLive=function(_,id,value) app:SetLive(id,value) end}
    app.Version='3.1.0-language-preview';app.APIVersion=3
    env[key]=app.Runtime
