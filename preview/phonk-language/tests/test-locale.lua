...
local l=I.new('Automatic (Roblox)','ru-ru');assert(l:T('Settings')=='Настройки')
...
for lang,pack in pairs(I.Packs)do local n=0;for k,v in pairs(pack)do n=n+1;assert(type(v)=='string' and #v>0);assert(utf8.len(v),'invalid UTF8: '..lang..' '..k)end;assert(n==117)end
