...
local outer=game:HttpGet(PROTECTED.."?v=mainstyle-keyfix-20260824",true)
local uiPatch=game:HttpGet(UIPATCH.."?v=mainstyle-keyfix-20260824",true)
...
local fn,err=loadstring(outer,"@SerenityShield/AccessV2-MainStyle-KeyFix")
outer=nil
if not fn then
